(function(){
  ...
  function flexCalendar() {
    ...
    '<div class="flex-calendar">'+
      '<div class="row month">'+
        '<div class="col-10 arrow {{arrowPrevClass}}" ng-click="prevMonth()"></div>'+
        '<div class="col label">{{ selectedMonth | translate }} {{selectedYear}}</div>'+
        '<div class="col-10 arrow {{arrowNextClass}}" ng-click="nextMonth()"></div>'+
      '</div>'+
      '<div class="week">'+
